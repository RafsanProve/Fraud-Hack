            ...
            Expanded(
              child: PageView(
                ...
                children: [
                  ...
                  buildPage("Detect fraudulent", "", "assets/OS3.png",
                      "transactions in real-time."),
                  buildPage("Get AI-driven", "", "assets/OS4.png", "financial recommendations"),
                ],
              ),
            ),
            Row(
    ...
    return Column(
      ...
      children: [
        ...
        subtitle != "" ? Text(subtitle,
            style: TextStyle(fontSize: 64, fontWeight: FontWeight.bold, fontFamily: "Italianno")) : SizedBox(height: 0),
        SizedBox(height: 20),
